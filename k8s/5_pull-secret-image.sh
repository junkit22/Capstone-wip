...
# Define directories
FLASK_APP_DIR="../flask-app"  # Path to the flask-app directory relative to k8s
...
cd "$FLASK_APP_DIR" || { echo "Failed to navigate to $FLASK_APP_DIR. Directory does not exist."; exit 1; }
